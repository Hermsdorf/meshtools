...
//static unsigned int tet4_edges[12]  = {0,1,0,3,1,2,1,3,2,0,2,3}; // 3D
static unsigned int tet4_edges[12]  = {0,1,1,2,2,0,0,3,1,3,2,3}; // 3D

//unsigned int hex8_faces[6][4]  = {{0,1,2,3},{4,5,6,7},{0,1,5,4},{1,2,6,5},{2,3,7,6},{3,0,4,7}};

static unsigned int hex8_faces[24]  = {0,1,2,3,
                                       0,1,5,4,
                                       1,2,6,5,
                                       2,3,7,6,
                                       3,0,4,7,
...
//static unsigned int hex8_edges[24]  = {0,1,1,2,2,3,3,0,0,4,1,5,2,6,3,7,4,5,5,6,6,7,7,4}; // 3D

static unsigned int hex8_edges[24]  = {0,1,1,2,2,3,3,0,
                                       4,5,5,6,6,7,7,4,
                                       0,4,1,5,2,6,3,7}; // 3D
...
static std::map<int,int> VtkIdToNumberOfNodes     = {{3,1},{5,2},{9,2},{10,3},{12,3}};

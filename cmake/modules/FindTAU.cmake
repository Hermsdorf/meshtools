...
find_program (TAU_C_CONFIG NAMES tau_cc.sh 
              PATHS 
...
if(TAU_TAU_C_CONFIG)
    set(TAU_C_COMPILER "${TAU_C_CONFIG}")
endif()

find_program (TAU_F_CONFIG NAMES tau_f90.sh 
              PATHS 
              "${TAU_DIR}/${TAU_ARCH}/bin"
              ENV PATH
              NO_DEFAULT_PATH)
...
if(TAU_F_CONFIG)
    set(TAU_F90_COMPILER "${TAU_F_CONFIG}")
endif()
...
if(TAU_CONFIG)
    set(TAU_CXX_COMPILER "${TAU_CONFIG}")
    IF (NOT TAU_FIND_QUIETLY)

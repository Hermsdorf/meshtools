...
#    MTMETIS_FOUND          (BOOL)       Flag indicating if MTMETIS was found
...
# Metis sometimes puts the include files in a subdir called Lib
    ...
    if ( NOT METIS_INCLUDE_DIR )
    	find_path(METIS_INCLUDE_DIR
                  NAMES ${metis_inc_names}
		  PATHS "/software/local/metis/5.0.3"
                  PATH_SUFFIXES ${metis_inc_suffixes})
    endif()
...
# find_package_handle_standard_args should set MTMETIS_FOUND but it does not!
if ( METIS_LIBRARIES AND METIS_INCLUDE_DIRS)
    set(MTMETIS_FOUND TRUE)
else()
    set(MTMETIS_FOUND FALSE)
endif()

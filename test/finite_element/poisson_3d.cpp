...
static char help[] = "3D Poisson Problem\n\n";
...
int poisson(int argc, char *argv[])
{
    ...
    auto  mesh  = MeshTools::read(std::string(MESHTOOLS_SOURCE_DIR)+"/test/finite_element/msh/poisson_3d/poisson3d.msh");
       
    auto  implicit_system = ImplicitSystem::New(mesh, "poisson");

...
double compute_H1_error(ImplicitSystem& system, int dof)
{
    ...
    for(int iel = 0; iel < n_elements; ++iel)
    {
        ...
        for(int q = 0; q < qp.size(); q++)
        {
            ...
            double val_error  = (gradu - gradu_h).norm(); // Norm of the difference between the derivative of exact solution and the derivative of numerical solution

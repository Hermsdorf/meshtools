...
- Para a reordenação nodal é possível utilizar de dois algoritmos, o METIS_ND o qual utiliza o algoritmo Multilevel Nested Dissection, ou o Reverse Cuthill McKee. É recomendado o algoritmo RCM pelo mesmo ter um melhor resultado gerando uma menor largura de banda. Para aplicar a técnica de reordenação deve ser utilizada da rotina *MeshReordering* passando por argumento o algoritmo desejado (RCM ou METIS_ND).
